...
public class VisualizarDeficienciasNegadasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new DeficienciaAdapterSingle(deficienciaList);
    ...
    private void buscarDeficienciasPendentes() {
        db.collection("deficiencias")
                ...
                .addOnFailureListener(e -> {
                    ...
                    Toast.makeText(VisualizarDeficienciasNegadasActivity.this, "Erro ao carregar dados.", Toast.LENGTH_SHORT).show();
                });
    }
}
